...
public class ImportScheduleDtoValidator : BaseValidator<ScheduleImportDto>
{
    ...
    private bool BeAValidDate(string dateString) => DateOnly.TryParse(dateString, out _);
    private bool BeAValidTime(string timeString) => TimeOnly.TryParse(timeString, out _);
