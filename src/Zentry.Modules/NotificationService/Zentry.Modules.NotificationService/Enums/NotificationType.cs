...
public class NotificationType : Enumeration
{
    ...
    public static NotificationType FromName(string name) => FromName<NotificationType>(name);
    public static NotificationType FromId(int id) => FromId<NotificationType>(id);
}
