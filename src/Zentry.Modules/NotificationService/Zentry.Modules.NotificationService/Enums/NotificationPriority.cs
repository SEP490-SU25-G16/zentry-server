...
public class NotificationPriority : Enumeration
{
    ...
    public static NotificationPriority FromName(string name) => FromName<NotificationPriority>(name);
    public static NotificationPriority FromId(int id) => FromId<NotificationPriority>(id);
}
